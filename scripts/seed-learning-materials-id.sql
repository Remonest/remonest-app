// File: scripts/seed-learning-materials-id.sql
// Seed learning materials in Bahasa Indonesia
// Run: supabase db push --local OR paste in Supabase SQL Editor

-- ============================================================
-- Material 1: Remote Working Basics
-- Module: Remote Working Basics (slug: remote-working-basics)
-- ============================================================

-- Cek module_id untuk remote-working-basics
DO $$
DECLARE
  v_module_id UUID;
BEGIN
  ...
  IF v_module_id IS NULL THEN
    RAISE EXCEPTION 'Module remote-working-basics tidak ditemukan!';
  END IF;

  -- Hapus materi lama dari Buffer (raw, tidak diterjemahkan)
  DELETE FROM learning_materials WHERE source_url LIKE 'https://buffer.com%';

  -- Materi 1: Pengantar Remote Working
...
',
    'Panduan komprehensif untuk memulai bekerja dari rumah, mencakup setup ruang kerja, manajemen waktu, komunikasi efektif, tools kolaborasi, dan tips kesehatan mental untuk remote worker Indonesia.',
    'article',
    'id',
    15,
    'beginner',
    ARRAY['remote work', 'produktivitas', 'komunikasi', 'tools', 'work from home'],
    true
  );
END $$;
...
-- ============================================================
-- Material 2: Skill Freelance
-- Module: Skill Freelance (slug: skill-freelance)
-- ============================================================
...
DECLARE
  v_module_id UUID;
BEGIN
  SELECT id INTO v_module_id FROM learning_modules WHERE slug = 'skill-freelance';
  
  IF v_module_id IS NULL THEN
    RAISE EXCEPTION 'Module skill-freelance tidak ditemukan!';
  END IF;
  ...
  INSERT INTO learning_materials (
    ...
    v_module_id,
    'Panduan Memulai Karir Freelance untuk Pemula',
    '# Panduan Memulai Karir Freelance untuk Pemula
...
',
    'Panduan lengkap memulai karir freelance, dari menentukan niche, membuat portofolio, menentukan tarif, mendapatkan klien pertama, hingga mengelola bisnis freelance secara profesional.',
    'article',
    'id',
    15,
    'beginner',
    ARRAY['freelance', 'portofolio', 'klien', 'tarif', 'karir'],
    true
  );
END $$;
