...
function getActionLabel(actionType: string): string {
  const labels: Record<string, string> = {
    ...
    create_learning_material: "Menambah Materi",
    update_learning_material: "Memperbarui Materi",
    delete_learning_material: "Menghapus Materi",
    create_learning_resource: "Menambah Resource",
    delete_learning_resource: "Menghapus Resource",
...
function getActionVariant(actionType: string): "default" | "secondary" | "destructive" | "outline" {
  const variants: Record<string, "default" | "secondary" | "destructive" | "outline"> = {
    ...
    create_learning_material: "default",
    update_learning_material: "outline",
    delete_learning_material: "destructive",
    create_learning_resource: "default",
    delete_learning_resource: "destructive",
